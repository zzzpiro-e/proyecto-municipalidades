...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		 ...
		 * (i.e. "Mostrando 1 de 10 of 57 entries") DataTables will render large numbers
		...
		"oLanguage": {
			 ...
			 *
			 *  @type string
			 *  @default Mostrando _START_ a _END_ de un total de _TOTAL_ registros
			 *
			 *  @dtopt Language
			 ...
			 *  @type string
			 *  @default Mostrando 0 a 0 de un total de 0 registros
			 *
			 *  @dtopt Language
			 ...
			 *  @type string
			 *  @default (filtrado de _MAX_ total entries)
			 *
			 *  @dtopt Language
